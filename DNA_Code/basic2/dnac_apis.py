...
def get_all_log(limit, dnac_jwt_token):
    """
    The function will return all network devices info
    :param dnac_jwt_token: DNA C token
    :return: DNA C device inventory info
    """
    #url = DNAC_URL + '/api/v1/task?username=h421923&startTime=1609891200000&endTime=1609977600000'
    #url = DNAC_URL + '/api/v1/audit?auditParentId=&limit=10000&offset=0&orderBy=createdDateTime&orderByType=desc&auditRequestor=h421923'
    #url = DNAC_URL + '/api/v1/task?auditParentId=&limit=10000&offset=0&username=h421923&serviceType=NCTP'
    #url = DNAC_URL + '/api/v1/task?username=h421923&limit=500&offset=0'
    #url = DNAC_URL + '/api/v1/audit?auditParentId=&limit=10000&offset=0&auditRequestor=h421923&!auditPayloadDetails&!auditCustomParameters'
    url = DNAC_URL + '/api/v1/audit?auditParentId=&limit=10000&offset=0&orderBy=createdDateTime&orderByType=desc&auditRequestor=h421923'
    header = {'content-type': 'application/json', 'x-auth-token': dnac_jwt_token}
    all_task_response = requests.get(url, headers=header, verify=False)
    all_task_info = all_task_response.json()
...
def get_application_health(device_id, limit, dnac_jwt_token):
    """
    The function will return all network devices info
    :param dnac_jwt_token: DNA C token
    :return: DNA C device inventory info
    ...
    while all_devices_info:
        all_devices_info = ''
        url = DNAC_URL + '/dna/intent/api/v1/application_health/?deviceId=' + deviceId
        header = {'content-type': 'application/json', 'x-auth-token': dnac_jwt_token}
        all_devices_response = requests.get(url, headers=header, verify=False)
        all_devices_json = all_devices_response.json()
        #all_devices_info = all_devices_json['response']
...
def get_audit_details(limit, dnac_jwt_token):
    """
    ...
    while all_devices_info:
        all_devices_info = ''
        url = DNAC_URL + '/api/v1/archive-config?offset=' + str(offset) + '&limit=' + str(limit) 
        #url = DNAC_URL + '/api/v1/archive-config/deviceId=&limit=500&offset=1'
        header = {'content-type': 'application/json', 'x-auth-token': dnac_jwt_token}
        all_devices_response = requests.get(url, headers=header, verify=False)
        all_devices_json = all_devices_response.json()
        #all_devices_info = all_devices_json['response']
...
def get_reachablity(dnac_jwt_token):

    #url = DNAC_URL + '/api/v1/archive-config/deviceName?offset=' + str(offset) + '&limit=' + str(limit)
    url = DNAC_URL + '/api/v1/reachability-info'
    header = {'content-type': 'application/json', 'x-auth-token': dnac_jwt_token}
    all_devices_response = requests.get(url, headers=header, verify=False)
    all_devices_json = all_devices_response.json()
    #all_devices_info = all_devices_json['response']
...
def get_device_membership(site_id, dnac_jwt_token):
    """
    This function will get the configuration file for the device with the name {device_name}
    :param device_name: device hostname
    :param dnac_jwt_token: DNA C token
    ...
    """
    site_id = get_site_id(site_name, dnac_jwt_token)
    url = DNAC_URL + '/api/v1/membership/' + site_id
    #url = DNAC_URL +'/api/v1/network-device/{}/config'.format(device_id)
    header = {'content-type': 'application/json', 'x-auth-token': dnac_jwt_token}
    response = requests.get(url, headers=header, verify=False)
    config_json = response.json()
...
def get_device_assurance(dnac_jwt_token):
    """
    This function will get the configuration file for the device with the name {device_name}
    :param device_name: device hostname
    :param dnac_jwt_token: DNA C token
    ...
    #site_id = get_site_id(site_name, dnac_jwt_token)
    url = DNAC_URL + "/assurance/v1/network-device?startTime={}&endTime={}".format(start,now)
    #url = DNAC_URL +'/api/v1/network-device/{}/config'.format(device_id)
    header = {'content-type': 'application/json', 'x-auth-token': dnac_jwt_token}
    response = requests.get(url, headers=header, verify=False)
    config_json = response.json()
...
def get_discovery(startIndex, recordsToReturn, dnac_jwt_token):
    """
    """
    url = DNAC_URL + '/api/v1/discovery/?startIndex=' + str(startIndex) + '/?recordsToReturn=' + str(recordsToReturn)
    header = {'content-type': 'application/json', 'x-auth-token': dnac_jwt_token}
    all_device_response = requests.get(url, headers=header, verify=False)
    all_device_info = all_device_response.json()
    return all_device_info['response']    
