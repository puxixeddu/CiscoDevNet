...
from env_lab import DNAC, DNAC_PORT, DNAC_USER, DNAC_PASSWORD, DEVICE_FAMILY
...
def main():
    ...
    for switch in switch_list_reachable[first_record:]:
        ...
        print(switch)
        # device_config = dnac_apis.get_device_config_new(device_hostname, dnac_auth)
        device_config = dnac_apis.get_device_config_backup(device_hostname, dnac_auth)
        print(device_config)
