...
dnac_devices = PrettyTable(['Hostname','device_id','Platform Id','Software Type','Software Version','Up Time' ])
...
def get_device_list():
    ...
    for item in device_list['response']:
       dnac_devices.add_row([item["hostname"],item["id"],item["platformId"],item["softwareType"],item["softwareVersion"],item["upTime"]])
    print(dnac_devices)   
